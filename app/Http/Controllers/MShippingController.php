...
class MShippingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('manager.shipping.index')->with('shippings', $shipping);
    }
    ...
    {
        return view('manager.shipping.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('Mshipping.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('manager.shipping.edit')->with('shipping', $shipping);
    }
