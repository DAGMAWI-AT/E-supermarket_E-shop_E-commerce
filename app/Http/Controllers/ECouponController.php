...
class ECouponController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee.coupon.index')->with('coupons', $coupon);
    }
    ...
    {
        return view('employee.coupon.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('Ecoupon.index');
    }
    ...
    public function edit($id)
    {
        ...
        if ($coupon) {
            return view('employee.coupon.edit')->with('coupon', $coupon);
        } else {
            return view('employee.coupon.index')->with('error', 'Coupon not found');
        }
    }
