...
class SKPostCategoryController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('storekeeper.postcategory.index')->with('postCategories', $postCategory);
    }
    ...
    {
        return view('storekeeper.postcategory.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('SKpost-category.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('storekeeper.postcategory.edit')->with('postCategory', $postCategory);
    }
