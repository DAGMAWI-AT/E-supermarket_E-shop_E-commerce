...
class MMessageController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('manager.message.index')->with('messages', $messages);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        if ($message) {
            ...
            return view('manager.message.show')->with('message', $message);
        } else {
            return back();
        }
    }
