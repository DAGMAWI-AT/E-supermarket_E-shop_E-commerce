...
class MPostTagController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('manager.posttag.index')->with('postTags',$postTag);
    }
    ...
    {
        return view('manager.posttag.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('Mpost-tag.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('manager.posttag.edit')->with('postTag', $postTag);
    }
