...
class EPostTagController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('employee.posttag.index')->with('postTags',$postTag);
    }
    ...
    {
        return view('employee.posttag.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('Epost-tag.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('employee.posttag.edit')->with('postTag', $postTag);
    }
