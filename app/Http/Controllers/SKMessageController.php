...
class SKMessageController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('storekeeper.message.index')->with('messages', $messages);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        if ($message) {
            ...
            return view('storekeeper.message.show')->with('message', $message);
        } else {
            return back();
        }
    }
