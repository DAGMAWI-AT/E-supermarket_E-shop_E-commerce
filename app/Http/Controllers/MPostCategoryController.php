...
class MPostCategoryController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('manager.postcategory.index')->with('postCategories', $postCategory);
    }
    ...
    {
        return view('manager.postcategory.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('Mpost-category.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('manager.postcategory.edit')->with('postCategory', $postCategory);
    }
