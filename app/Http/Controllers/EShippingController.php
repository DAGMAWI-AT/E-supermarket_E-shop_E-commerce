...
class EShippingController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('employee.shipping.index')->with('shippings', $shipping);
    }
    ...
    {
        return view('employee.shipping.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('Eshipping.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('employee.shipping.edit')->with('shipping', $shipping);
    }
