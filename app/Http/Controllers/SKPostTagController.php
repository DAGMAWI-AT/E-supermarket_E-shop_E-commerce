...
class SKPostTagController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('storekeeper.posttag.index')->with('postTags',$postTag);
    }
    ...
    {
        return view('storekeeper.posttag.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('SKpost-tag.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('storekeeper.posttag.edit')->with('postTag', $postTag);
    }
