...
class MPostCommentController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('manager.comment.index')->with('comments', $comments);
    }
    ...
    public function show($id)
    {
        ...
        // return $order;
        return view('manager.comment.show')->with('comment', $comments);
    }
    ...
    public function edit($id)
    {
        $comments = PostComment::find($id);
        if ($comments) {
            return view('manager.comment.edit')->with('comment', $comments);
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($comment) {
            ...
            return redirect()->route('Mcomment.index');
        } else {
            request()->session()->flash('error', 'Comment not found');
            return redirect()->back();
        }
