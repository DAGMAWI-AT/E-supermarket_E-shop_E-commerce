...
class HomeController extends Controller
{
    ...
    public function profile()
    {
        $profile = Auth()->user();
        // return $profile;
        return view('frontend.users.profile')->with('profile', $profile);
    }
    ...
    public function orderShow($id)
    {
        $order=Order::find($id);
        // return $order;
        return view('frontend.order.show')->with('order',$order);
    }
    ...
    {
        $order=Order::find($id);
        return view('frontend.order.edit')->with('order',$order);
    }
