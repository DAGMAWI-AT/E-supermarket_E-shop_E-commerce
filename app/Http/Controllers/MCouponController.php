...
class MCouponController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('manager.coupon.index')->with('coupons', $coupon);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('Mcoupon.index');
    }
    ...
    public function edit($id)
    {
        ...
        if ($coupon) {
            ...
            return view('manager.coupon.index')->with('error', 'Coupon not found');
        }
    }
