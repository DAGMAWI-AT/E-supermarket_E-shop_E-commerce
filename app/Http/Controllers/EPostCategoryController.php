...
class EPostCategoryController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('employee.postcategory.index')->with('postCategories', $postCategory);
    }
    ...
    {
        return view('employee.postcategory.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('Epost-category.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('employee.postcategory.edit')->with('postCategory', $postCategory);
    }
