...
class SKShippingController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('storekeeper.shipping.index')->with('shippings', $shipping);
    }
    ...
    {
        return view('storekeeper.shipping.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('SKshipping.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('storekeeper.shipping.edit')->with('shipping', $shipping);
    }
