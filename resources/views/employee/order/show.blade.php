...
<div class="card">
  <h5 class="card-header">Order
    <a href="{{route('eorder.pdf', $order->id)}}" class=" btn btn-sm btn-primary shadow-sm float-right"><i class="fas fa-download fa-sm text-white-50"></i> Generate PDF</a>
  </h5>
  <div class="card-body">
    @if ($order)
          ...
          <div class="col-lg-6 col-lx-4">
            <div class="order-info">
              ...
              <table class="table">
                    ...
                    <tr>
                      <td>Coupon :</td>
                      <td> Birr {{number_format($order->coupon, 2)}}</td>
                    </tr>
                    <tr>
                        <td>Total Amount :</td>
                        <td> Birr {{number_format($order->total_amount, 2)}}</td>
