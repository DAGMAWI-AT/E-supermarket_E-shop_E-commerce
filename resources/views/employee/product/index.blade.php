...
@section('main-content')
 ...
 <div class="card shadow mb-4">
     ...
     <div>
     <a href="{{route('PRODUCT.productEXCEL')}}" class=" btn btn-sm btn-primary shadow-sm float-center"><i class="fas fa-download fa-sm text-white-50"></i> Generate EXCEL</a>
</div>
    <div class="card-header py-3">
      
      <h6 class="m-0 font-weight-bold text-primary float-left">Product Lists</h6>
      
      <a href="{{route('Eproduct.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Product</a>
    </div>
    <div class="card-body">
          ...
          @foreach ($products as $product)
              ...
              @endphp
                <tr>
                    ...
                    <td>
                      <a href="{{route('Eproduct.edit', $product->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="Edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                   </td>
                    <!-- <td>
                      <a href="{{route('Eproduct.edit', $product->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="Edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                      <form method="POST" action="{{route('Eproduct.destroy', [$product->id])}}">
                        @csrf
                        @method('delete')
