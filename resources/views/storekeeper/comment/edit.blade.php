...
<div class="card">
  ...
  <div class="card-body">
    <form action="{{route('SKcomment.update', $comment->id)}}" method="POST">
      @csrf
      @method('PATCH')
      ...
      <textarea name="comment" id="" cols="20" rows="10" class="form-control"disabled>{{$comment->comment}}</textarea>
      </div>
      <div class="form-group">
