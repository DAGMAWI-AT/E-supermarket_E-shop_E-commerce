            ...
            {{-- {{$comment}}   --}}
              ...
              @endphp
                <tr>
                    ...
                    <td>@foreach($title as $data) <a href="{{route('SKcomment.show', $comment->id)}}"> {{ $data->title}} @endforeach</td>
                    ...
                    <td>
                       <a href="{{route('SKcomment.show', $comment->id)}}" class="btn btn-warning btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="View" data-placement="bottom"><i class="fas fa-eye"></i></a>
                        <a href="{{route('SKcomment.edit', $comment->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="Edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                        <form method="POST" action="{{route('SKcomment.destroy', [$comment->id])}}">
                          @csrf
                          @method('delete')
