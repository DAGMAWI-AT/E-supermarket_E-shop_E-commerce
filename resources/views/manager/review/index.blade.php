            ...
            @foreach ($reviews as $review)
              ...
              @endphp
                <tr>
                    ...
                    <td>
                        <a href="{{route('manager.productreview.edit', $review->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="Edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                        <form method="POST" action="{{route('manager.productreview.delete', [$review->id])}}">
                          @csrf
                          @method('delete')
