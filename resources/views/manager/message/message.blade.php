    ...
    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
        ...
        <div id="message-items">
            @foreach (Helper::messageList() as $message)
                <a class="dropdown-item d-flex align-items-center" href="{{route('Mmessage.show', $message->id)}}">
        ...
        <a class="dropdown-item text-center small text-gray-500" href="{{route('Mmessage.index')}}">Read More Messages</a>
    </div>
</div>
