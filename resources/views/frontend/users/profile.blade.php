            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body mt-4 ml-2">
                      <h5 class="card-title text-left"><small><i class="fas ti-user"></i> {{$profile->name}}</small></h5>
                      <p class="card-text text-left"><small><i class="fas ti-envelope"></i> {{$profile->email}}</small></p>
                      <p class="card-text text-left"><small class="text-muted"><i class="fas ti-hammer"></i> {{$profile->role}}</small></p>
                    </div>
                  </div>
            </div>
            <div class="col-md-8">
